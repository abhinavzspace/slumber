[![slumber](http://i.imgur.com/RXDVdB0.png)](https://github.com/abhinavzspace/slumber)
[![Build Status](https://drone.io/github.com/abhinavzspace/slumber/status.png)](https://drone.io/github.com/abhinavzspace/slumber/latest)
[![Coverage Status](https://coveralls.io/repos/abhinavzspace/slumber/badge.svg?branch=master)](https://coveralls.io/r/abhinavzspace/slumber?branch=master)
...
go get github.com/abhinavzspace/slumber

# go to package root folder
cd $GOPATH/src/github.com/abhinavzspace/slumber
...
## Code coverage
Coveralls.io link: [https://coveralls.io/r/abhinavzspace/slumber]
...
```bash
go tool cover -html=$GOPATH/src/github.com/abhinavzspace/slumber/slumber.coverprofile
```
